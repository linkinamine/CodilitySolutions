 ...
 * we say that two fish P and Q meet each other when P < Q, B[P] = 1 and B[Q] = 0, and there are no living fish between them.
 *
 * After they meet:
...
object Fish {
    ...
    fun solution(A: IntArray, B: IntArray): Int {
        ...
        var numberOfAliveFishes = A.size

        // Push the size of the downstream fish
        val stack = Stack<Int>()
